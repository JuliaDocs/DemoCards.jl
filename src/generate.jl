...
function makedemos(source::String;
    ...
    save_democards(absolute_root, page; credit=credit) # WARNING: julia cards are reconfigured here
...
"""
    save_democards(root::String, page::DemoPage; credit)

recursively process and save source demo file
"""
save_democards(root::String, page::DemoPage; credit) = save_democards.(root, page.sections; credit=credit)
function save_democards(root::String, sec::DemoSection; credit)
    save_democards.(joinpath(root, basename(sec.root)), sec.subsections; credit=credit)
    save_democards.(joinpath(root, basename(sec.root)), sec.cards; credit=credit)
end
